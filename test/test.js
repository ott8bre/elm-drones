...
var _ott8bre$elm_drones$Test_Point$tests = function () {
	var basicsTests = A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				A2(
					_elm_community$elm_test$ElmTest$assertEqual,
					0,
					A2(_ott8bre$elm_drones$Point$distance, _ott8bre$elm_drones$Point$origin, _ott8bre$elm_drones$Point$origin))),
				A2(
				_elm_community$elm_test$ElmTest$test,
				'distance (1,1) (2,2)',
				A2(
					_elm_community$elm_test$ElmTest$assertEqual,
					_elm_lang$core$Basics$sqrt(2),
					A2(
						_ott8bre$elm_drones$Point$distance,
						A2(_ott8bre$elm_drones$Point$Point, 1, 1),
						A2(_ott8bre$elm_drones$Point$Point, 2, 2))))
			]));
	return A2(
		_elm_community$elm_test$ElmTest$suite,
		'Point',
...
var _ott8bre$elm_drones$Test_Packet$sample = A4(_ott8bre$elm_drones$Packet$init, 1, 1, _ott8bre$elm_drones$Point$origin, _ott8bre$elm_drones$Point$origin);
var _ott8bre$elm_drones$Test_Packet$tests = function () {
	var basicsTests = A2(
		_elm_community$elm_test$ElmTest$suite,
		'Basics',
		_elm_lang$core$Native_List.fromArray(
			[
				...
				A2(
					...
					function (_) {
						return _.item;
					}(_ott8bre$elm_drones$Test_Packet$sample))),
				A2(
				_elm_community$elm_test$ElmTest$test,
				'init .copies',
				A2(
				...
				A2(
					_elm_community$elm_test$ElmTest$assertEqual,
					_ott8bre$elm_drones$Env$weightOf(1),
					_ott8bre$elm_drones$Packet$weight(_ott8bre$elm_drones$Test_Packet$sample)))
			]));
	return A2(
		_elm_community$elm_test$ElmTest$suite,
		'Packet',
...
var _ott8bre$elm_drones$Test_Drone$packet = A4(_ott8bre$elm_drones$Packet$init, 1, 1, _ott8bre$elm_drones$Point$origin, _ott8bre$elm_drones$Point$origin);
var _ott8bre$elm_drones$Test_Drone$sample = A2(_ott8bre$elm_drones$Drone$init, 1, _ott8bre$elm_drones$Point$origin);
var _ott8bre$elm_drones$Test_Drone$sampleTake = A2(
	_ott8bre$elm_drones$Drone$enqueue,
	_ott8bre$elm_drones$Drone$Take(_ott8bre$elm_drones$Test_Drone$packet),
	_ott8bre$elm_drones$Test_Drone$sample);
var _ott8bre$elm_drones$Test_Drone$tests = function () {
	var takeTests = A2(
		_elm_community$elm_test$ElmTest$suite,
		'Take',
		_elm_lang$core$Native_List.fromArray(
			[
				...
				A2(
					...
					_elm_lang$core$List$length(
						function (_) {
							return _.schedule;
						}(_ott8bre$elm_drones$Test_Drone$sampleTake))))
			]));
	var basicsTests = A2(
		_elm_community$elm_test$ElmTest$suite,
		'Basics',
		_elm_lang$core$Native_List.fromArray(
			[
				...
				A2(
					_elm_community$elm_test$ElmTest$assertEqual,
					0,
					_ott8bre$elm_drones$Drone$weight(_ott8bre$elm_drones$Test_Drone$sample)))
			]));
	return A2(
		_elm_community$elm_test$ElmTest$suite,
		'Drone',
		_elm_lang$core$Native_List.fromArray(
			[basicsTests, takeTests]));
}();

var _ott8bre$elm_drones$Main$tests = A2(
	_elm_community$elm_test$ElmTest$suite,
	'Elm Drones Library Tests',
	_elm_lang$core$Native_List.fromArray(
		[_ott8bre$elm_drones$Test_Point$tests, _ott8bre$elm_drones$Test_Drone$tests, _ott8bre$elm_drones$Test_Packet$tests]));
var _ott8bre$elm_drones$Main$main = {
	main: _elm_community$elm_test$ElmTest$runSuite(_ott8bre$elm_drones$Main$tests)
};
