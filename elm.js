...
var _ott8bre$elm_drones$Env$warehouses = _elm_lang$core$Native_List.fromArray(
	[
		{
		...
		switch (_p1.ctor) {
			case 'Take':
				return _elm_lang$core$Native_Utils.update(
					drone,
					{
						schedule: A2(_elm_lang$core$List_ops['::'], msg, drone.schedule)
					});
			case 'Drop':
				return _elm_lang$core$Native_Utils.update(
					drone,
	...
	function (load, point) {
		return {
			schedule: _elm_lang$core$Native_List.fromArray(
				[]),
			packets: _elm_lang$core$Native_List.fromArray(
				[]),
			position: point,
			maxLoad: load
		};
		...
		var func = F2(
			function (drone, _p0) {
				...
				var takeDrop = F2(
					function (packet, _p2) {
						...
						return A2(_ott8bre$elm_drones$Drone$canLoad, packet, _p4) ? {
							...
							ctor: '_Tuple2',
							_0: _p4,
							_1: A2(_elm_lang$core$List_ops['::'], packet, _p5)
						};
					});
				var _p6 = A3(
					_elm_lang$core$List$foldr,
				...
				return {
					...
					_1: A2(
						_elm_lang$core$List_ops['::'],
						_ott8bre$elm_drones$Drone$update(newDrone),
						_p1._1)
				};
			});
		return A3(
...
var _ott8bre$elm_drones$Update$init = {
	...
	_1: A3(
		...
		_ott8bre$elm_drones$Update$Resize,
		_elm_lang$window$Window$size)
};
...
var _ott8bre$elm_drones$Main$main = {
	main: _elm_lang$html$Html_App$program(
		{
			...
			subscriptions: function (_p1) {
				return _elm_lang$core$Platform_Sub$batch(
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$window$Window$resizes(_ott8bre$elm_drones$Update$Resize),
...
var Elm = {};
Elm['Main'] = Elm['Main'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['Main'], 'Main', typeof _ott8bre$elm_drones$Main$main === 'undefined' ? null : _ott8bre$elm_drones$Main$main);
