							...
							_0: _elm_lang$animation_frame$AnimationFrame$diffs(
								function (_p2) {
									return _ott8bre$elm_drones$Update$Tick(
										_elm_lang$core$Time$inSeconds(_p2));
								}),
							_1: {ctor: '[]'}
						}
					}
...
if (typeof _ott8bre$elm_drones$Main$main !== 'undefined') {
    _ott8bre$elm_drones$Main$main(Elm['Main'], 'Main', {"types":{"message":"Update.Msg","aliases":{"Window.Size":{"type":"{ width : Int, height : Int }","args":[]},"Time.Time":{"type":"Float","args":[]}},"unions":{"Update.Msg":{"tags":{"TogglePlay":[],"NoOp":[],"Resize":["Window.Size"],"Tick":["Time.Time"]},"args":[]}}},"versions":{"elm":"0.18.0"}});
}
