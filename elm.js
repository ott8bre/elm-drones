...
var _ott8bre$elm_drones$Point$distance = F2(
	function (p, q) {
...
var _ott8bre$elm_drones$Point$Point = F2(
	function (a, b) {
		return {x: a, y: b};
	});
var _ott8bre$elm_drones$Point$origin = A2(_ott8bre$elm_drones$Point$Point, 0, 0);

var _ott8bre$elm_drones$Env$warehouses = {
	ctor: '::',
	_0: {
		address: A2(_ott8bre$elm_drones$Point$Point, -100, 0),
...
var _ott8bre$elm_drones$Env$orders = {
	ctor: '::',
	_0: {
		address: A2(_ott8bre$elm_drones$Point$Point, 200, 100),
		items: _elm_lang$core$Array$fromList(
			{
				ctor: '::',
				_0: 0,
	...
	_1: {
		ctor: '::',
		_0: {
			address: A2(_ott8bre$elm_drones$Point$Point, -150, 100),
			items: _elm_lang$core$Array$fromList(
				{
					ctor: '::',
					_0: 0,
		...
		_1: {
			ctor: '::',
			_0: {
				address: A2(_ott8bre$elm_drones$Point$Point, 150, -150),
				items: _elm_lang$core$Array$fromList(
					{
						ctor: '::',
						_0: 0,
			...
			_1: {
				ctor: '::',
				_0: {
					address: A2(_ott8bre$elm_drones$Point$Point, 250, 50),
					items: _elm_lang$core$Array$fromList(
						{
							ctor: '::',
							_0: 2,
				...
				_1: {
					...
					_1: {
						ctor: '::',
						_0: {
							address: A2(_ott8bre$elm_drones$Point$Point, 50, 50),
							items: _elm_lang$core$Array$fromList(
								{
									ctor: '::',
									_0: 2,
						...
						_1: {
							ctor: '::',
							_0: {
								address: A2(_ott8bre$elm_drones$Point$Point, -250, 190),
								items: _elm_lang$core$Array$fromList(
									{
										ctor: '::',
										_0: 2,
...
var _ott8bre$elm_drones$Env$weights = _elm_lang$core$Array$fromList(
	{
		ctor: '::',
		_0: 3,
		_1: {
...
var _ott8bre$elm_drones$Env$weightOf = function (index) {
	return A2(
		_elm_lang$core$Maybe$withDefault,
		0,
		A2(_elm_lang$core$Array$get, index, _ott8bre$elm_drones$Env$weights));
};
var _ott8bre$elm_drones$Env$numberOfDrones = 5;
var _ott8bre$elm_drones$Env$droneMaxLoad = 12;
var _ott8bre$elm_drones$Env$_p0 = {ctor: '_Tuple2', _0: 600, _1: 400};
var _ott8bre$elm_drones$Env$gameWidth = _ott8bre$elm_drones$Env$_p0._0;
var _ott8bre$elm_drones$Env$gameHeight = _ott8bre$elm_drones$Env$_p0._1;
var _ott8bre$elm_drones$Env$Target = F2(
	function (a, b) {
		return {address: a, items: b};
	});

var _ott8bre$elm_drones$Packet$weight = function (_p0) {
	var _p1 = _p0;
	return _p1.copies * _ott8bre$elm_drones$Env$weightOf(_p1.item);
};
var _ott8bre$elm_drones$Packet$init = F4(
	function (item, copies, from, to) {
		return {sender: from, recipient: to, item: item, copies: copies};
	});
var _ott8bre$elm_drones$Packet$Packet = F4(
	function (a, b, c, d) {
		return {sender: a, recipient: b, item: c, copies: d};
	});

var _ott8bre$elm_drones$Drone$weight = function (model) {
	return A3(
		_elm_lang$core$List$foldr,
		F2(
			function (x, y) {
		...
		0,
		A2(_elm_lang$core$List$map, _ott8bre$elm_drones$Packet$weight, model.packets));
};
var _ott8bre$elm_drones$Drone$canLoad = F2(
	function (packet, drone) {
		var f = function (msg) {
			var _p0 = msg;
			if (_p0.ctor === 'Take') {
				return _ott8bre$elm_drones$Packet$weight(_p0._0);
			} else {
				return 0;
			}
		};
		var takingWeight = _elm_lang$core$List$sum(
			A2(_elm_lang$core$List$map, f, drone.schedule));
		return _elm_lang$core$Native_Utils.cmp(
			(takingWeight + _ott8bre$elm_drones$Drone$weight(drone)) + _ott8bre$elm_drones$Packet$weight(packet),
			drone.maxLoad) < 1;
	});
var _ott8bre$elm_drones$Drone$isEmpty = function (model) {
	return _elm_lang$core$List$isEmpty(model.packets) && _elm_lang$core$List$isEmpty(model.schedule);
};
var _ott8bre$elm_drones$Drone$distance = F2(
	function (p, q) {
		return _elm_lang$core$Basics$floor(
			A2(_ott8bre$elm_drones$Point$distance, p, q));
	});
var _ott8bre$elm_drones$Drone$stepTo = F2(
	function (src, dest) {
		var d = A2(_ott8bre$elm_drones$Drone$distance, src, dest);
		var p = _elm_lang$core$Native_Utils.eq(d, 0) ? 1 : (1 / _elm_lang$core$Basics$toFloat(d));
		return _elm_lang$core$Native_Utils.update(
			src,
			{x: ((1 - p) * src.x) + (p * dest.x), y: ((1 - p) * src.y) + (p * dest.y)});
	});
var _ott8bre$elm_drones$Drone$enqueue = F2(
	function (msg, drone) {
		var _p1 = msg;
		switch (_p1.ctor) {
			case 'Take':
				return _elm_lang$core$Native_Utils.update(
					drone,
					{
						schedule: {ctor: '::', _0: msg, _1: drone.schedule}
					});
			case 'Drop':
				return _elm_lang$core$Native_Utils.update(
					drone,
...
var _ott8bre$elm_drones$Drone$init = F2(
	function (load, point) {
		return {
			schedule: {ctor: '[]'},
			packets: {ctor: '[]'},
...
var _ott8bre$elm_drones$Drone$Drone = F4(
	function (a, b, c, d) {
		return {schedule: a, packets: b, position: c, maxLoad: d};
	});
var _ott8bre$elm_drones$Drone$NoOp = {ctor: 'NoOp'};
var _ott8bre$elm_drones$Drone$update = function (model) {
	var currentMsg = A2(
		_elm_lang$core$Maybe$withDefault,
		_ott8bre$elm_drones$Drone$NoOp,
		_elm_lang$core$List$head(model.schedule));
	var _p2 = currentMsg;
	switch (_p2.ctor) {
		case 'Take':
			var _p3 = _p2._0;
			return _elm_lang$core$Native_Utils.eq(_p3.sender, model.position) ? _elm_lang$core$Native_Utils.update(
				model,
				{
					packets: A2(
						_elm_lang$core$Basics_ops['++'],
					...
					schedule: A2(_elm_lang$core$List$drop, 1, model.schedule)
				}) : _elm_lang$core$Native_Utils.update(
				model,
				{
					position: A2(_ott8bre$elm_drones$Drone$stepTo, model.position, _p3.sender)
				});
		case 'Drop':
			var _p4 = _p2._0;
			return _elm_lang$core$Native_Utils.eq(_p4.recipient, model.position) ? _elm_lang$core$Native_Utils.update(
				model,
				{
					packets: A2(
				...
				model,
				{
					position: A2(_ott8bre$elm_drones$Drone$stepTo, model.position, _p4.recipient)
				});
		default:
			return model;
	}
};
var _ott8bre$elm_drones$Drone$Drop = function (a) {
...
var _ott8bre$elm_drones$Model$Game = F6(
	function (a, b, c, d, e, f) {
		return {state: a, turn: b, size: c, drones: d, packets: e, products: f};
	});
var _ott8bre$elm_drones$Model$End = {ctor: 'End'};
var _ott8bre$elm_drones$Model$Pause = {ctor: 'Pause'};
var _ott8bre$elm_drones$Model$Play = {ctor: 'Play'};

var _ott8bre$elm_drones$View$make = F3(
	function (r, c, obj) {
		return A2(
			...
			A2(
				...
				c,
				A2(_evancz$elm_graphics$Collage$oval, r, r)));
	});
var _ott8bre$elm_drones$View$textColor = A3(_elm_lang$core$Color$rgb, 160, 200, 160);
var _ott8bre$elm_drones$View$txt = F2(
	function (f, string) {
		return _evancz$elm_graphics$Element$leftAligned(
			f(
				_evancz$elm_graphics$Text$monospace(
					A2(
						...
						_ott8bre$elm_drones$View$textColor,
						_evancz$elm_graphics$Text$fromString(string)))));
	});
var _ott8bre$elm_drones$View$droneColor = _elm_lang$core$Color$white;
var _ott8bre$elm_drones$View$orderColor = _elm_lang$core$Color$red;
var _ott8bre$elm_drones$View$wareColor = _elm_lang$core$Color$blue;
var _ott8bre$elm_drones$View$backgroundColor = A3(_elm_lang$core$Color$rgb, 10, 10, 10);
var _ott8bre$elm_drones$View$drawDrone = function (_p0) {
	var _p1 = _p0;
	...
	return A2(
		...
		A2(
			...
			A2(_evancz$elm_graphics$Collage$oval, 5, 5)));
};
var _ott8bre$elm_drones$View$square = F2(
	function (color, _p3) {
		var _p4 = _p3;
		return A2(
			_evancz$elm_graphics$Collage$move,
...
var _ott8bre$elm_drones$View$drawPackets = F4(
	function (x, y, i, order) {
		var k = _elm_lang$core$Basics$toFloat(1 + i);
		return A2(
			_ott8bre$elm_drones$View$square,
			_elm_lang$core$Color$brown,
			{ctor: '_Tuple2', _0: x - (5 * k), _1: y - 5});
	});
var _ott8bre$elm_drones$View$drawProducts = F4(
	function (x, y, i, size) {
		var range = A2(_elm_lang$core$List$range, 1, size);
		var k = _elm_lang$core$Basics$toFloat(1 + i);
		var f = function (h) {
			return A2(
				_ott8bre$elm_drones$View$square,
...
var _ott8bre$elm_drones$View$view = function (model) {
	var info = function () {
		var _p6 = model.state;
		if (_p6.ctor === 'Play') {
			return A2(_evancz$elm_graphics$Element$spacer, 1, 1);
		} else {
			return A2(_ott8bre$elm_drones$View$txt, _elm_lang$core$Basics$identity, 'press SPACE to start/pause');
		}
	}();
	var scores = function () {
		var _p7 = model.state;
	...
	return _evancz$elm_graphics$Element$toHtml(
		A4(
			...
			A3(
				...
				_ott8bre$elm_drones$Env$gameWidth,
				_ott8bre$elm_drones$Env$gameHeight,
				A2(
					_elm_lang$core$Basics_ops['++'],
					{
						ctor: '::',
						_0: A2(
							_evancz$elm_graphics$Collage$filled,
							_ott8bre$elm_drones$View$backgroundColor,
							A2(_evancz$elm_graphics$Collage$rect, _ott8bre$elm_drones$Env$gameWidth, _ott8bre$elm_drones$Env$gameHeight)),
						_1: {
							ctor: '::',
							_0: A2(
								_evancz$elm_graphics$Collage$move,
								{ctor: '_Tuple2', _0: 0, _1: (_ott8bre$elm_drones$Env$gameHeight / 2) - 40},
								_evancz$elm_graphics$Collage$toForm(scores)),
							_1: {
								ctor: '::',
								_0: A2(
									_evancz$elm_graphics$Collage$move,
									{ctor: '_Tuple2', _0: 0, _1: 40 - (_ott8bre$elm_drones$Env$gameHeight / 2)},
									_evancz$elm_graphics$Collage$toForm(info)),
								_1: {ctor: '[]'}
							}
						}
					},
					A2(
						...
						A2(
							...
							A2(
								_elm_lang$core$Basics_ops['++'],
								A2(_elm_lang$core$List$map, _ott8bre$elm_drones$View$drawDrone, model.drones),
								A2(
									_elm_lang$core$Basics_ops['++'],
									_elm_lang$core$List$concat(
										A2(
											_elm_lang$core$List$indexedMap,
											A2(_ott8bre$elm_drones$View$drawProducts, (0 - _ott8bre$elm_drones$Env$gameWidth) / 2, (0 - _ott8bre$elm_drones$Env$gameHeight) / 2),
											model.products)),
									A2(
										_elm_lang$core$List$indexedMap,
										A2(_ott8bre$elm_drones$View$drawPackets, _ott8bre$elm_drones$Env$gameWidth / 2, _ott8bre$elm_drones$Env$gameHeight / 2),
										model.packets)))))))));
};

var _ott8bre$elm_drones$Update$initDrone = A2(
	_ott8bre$elm_drones$Drone$init,
	_ott8bre$elm_drones$Env$droneMaxLoad,
	A2(
		_elm_lang$core$Maybe$withDefault,
		_ott8bre$elm_drones$Point$origin,
		A2(
			_elm_lang$core$Maybe$map,
			function (_) {
				return _.address;
			},
			_elm_lang$core$List$head(_ott8bre$elm_drones$Env$warehouses))));
var _ott8bre$elm_drones$Update$waresToProducts = function (ware) {
	return _elm_lang$core$List$sum(
		_elm_lang$core$Array$toList(ware.items));
};
var _ott8bre$elm_drones$Update$orderToPackets = function (order) {
	var start = A2(
		_elm_lang$core$Maybe$withDefault,
		_ott8bre$elm_drones$Point$origin,
		A2(
	...
	var f = F2(
		function (x, y) {
			return A4(_ott8bre$elm_drones$Packet$init, x, y, start, order.address);
		});
	var packs = A2(_elm_lang$core$Array$indexedMap, f, order.items);
	return A2(
		_elm_lang$core$List$filter,
		function (p) {
			return !_elm_lang$core$Native_Utils.eq(p.copies, 0);
		},
		_elm_lang$core$Array$toList(packs));
};
var _ott8bre$elm_drones$Update$initialModel = {
	state: _ott8bre$elm_drones$Model$Pause,
	turn: 0,
	size: A2(_elm_lang$window$Window$Size, 0, 0),
	drones: A2(_elm_lang$core$List$repeat, _ott8bre$elm_drones$Env$numberOfDrones, _ott8bre$elm_drones$Update$initDrone),
	packets: _elm_lang$core$List$concat(
		A2(_elm_lang$core$List$map, _ott8bre$elm_drones$Update$orderToPackets, _ott8bre$elm_drones$Env$orders)),
	products: A2(_elm_lang$core$List$map, _ott8bre$elm_drones$Update$waresToProducts, _ott8bre$elm_drones$Env$warehouses)
};
var _ott8bre$elm_drones$Update$updatePacketsDrones = F2(
			...
			function (drone, _p0) {
				...
				var takeDrop = F2(
					function (packet, _p2) {
						...
						var _p5 = _p3._1;
						var _p4 = _p3._0;
						return A2(_ott8bre$elm_drones$Drone$canLoad, packet, _p4) ? {
							ctor: '_Tuple2',
							_0: A2(
								_ott8bre$elm_drones$Drone$enqueue,
								_ott8bre$elm_drones$Drone$Drop(packet),
								A2(
									_ott8bre$elm_drones$Drone$enqueue,
									_ott8bre$elm_drones$Drone$Take(packet),
									_p4)),
							_1: _p5
						} : {
							ctor: '_Tuple2',
							_0: _p4,
							_1: {ctor: '::', _0: packet, _1: _p5}
						};
					});
				var _p6 = A3(
					_elm_lang$core$List$foldr,
				...
				return {
					...
					_1: {
						ctor: '::',
						_0: _ott8bre$elm_drones$Drone$update(newDrone),
						_1: _p1._1
					}
				};
			});
...
var _ott8bre$elm_drones$Update$update = F2(
	function (msg, model) {
		var _p7 = msg;
		switch (_p7.ctor) {
			case 'NoOp':
			...
			case 'TogglePlay':
				var newState = function () {
					var _p8 = model.state;
					if (_p8.ctor === 'Play') {
						return _ott8bre$elm_drones$Model$Pause;
					} else {
						return _ott8bre$elm_drones$Model$Play;
					}
				}();
				return _elm_lang$core$Native_Utils.eq(model.state, _ott8bre$elm_drones$Model$End) ? _elm_lang$core$Native_Utils.update(
					_ott8bre$elm_drones$Update$initialModel,
					{size: model.size}) : _elm_lang$core$Native_Utils.update(
					model,
					{state: newState});
			default:
				var _p9 = model.state;
				if (_p9.ctor === 'Play') {
					var _p10 = A2(_ott8bre$elm_drones$Update$updatePacketsDrones, model.packets, model.drones);
					var newPackets = _p10._0;
					var newDrones = _p10._1;
					...
					var newState = function () {
						var _p11 = terminated;
						if (_p11 === true) {
							return _ott8bre$elm_drones$Model$End;
						} else {
							return model.state;
						}
					}();
					var xxx = A2(_elm_lang$core$Debug$log, 'drones', model.drones);
					var roundPoint = function (p) {
						return {
							ctor: '_Tuple2',
							_0: _elm_lang$core$Basics$round(p.x),
							_1: _elm_lang$core$Basics$round(p.y)
						};
					};
					return _elm_lang$core$Native_Utils.update(
						model,
						{state: newState, turn: newTurn, drones: newDrones, packets: newPackets});
				} else {
					return model;
				}
		}
	});
var _ott8bre$elm_drones$Update$NoOp = {ctor: 'NoOp'};
var _ott8bre$elm_drones$Update$TogglePlay = {ctor: 'TogglePlay'};
var _ott8bre$elm_drones$Update$Tick = function (a) {
	return {ctor: 'Tick', _0: a};
};
var _ott8bre$elm_drones$Update$Resize = function (a) {
	return {ctor: 'Resize', _0: a};
};
var _ott8bre$elm_drones$Update$init = {
	ctor: '_Tuple2',
	_0: _ott8bre$elm_drones$Update$initialModel,
	_1: A2(_elm_lang$core$Task$perform, _ott8bre$elm_drones$Update$Resize, _elm_lang$window$Window$size)
};

var _ott8bre$elm_drones$Main$keyboardProcessor = function (keyCode) {
	var _p0 = keyCode;
	if (_p0 === 32) {
		return _ott8bre$elm_drones$Update$TogglePlay;
	} else {
		return _ott8bre$elm_drones$Update$NoOp;
	}
};
var _ott8bre$elm_drones$Main$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$batch(
		{
			ctor: '::',
			_0: _elm_lang$window$Window$resizes(_ott8bre$elm_drones$Update$Resize),
			_1: {
				ctor: '::',
				_0: _elm_lang$keyboard$Keyboard$ups(_ott8bre$elm_drones$Main$keyboardProcessor),
				_1: {
					ctor: '::',
					_0: _elm_lang$core$Native_Utils.eq(model.state, _ott8bre$elm_drones$Model$Pause) ? _elm_lang$core$Platform_Sub$none : _elm_lang$animation_frame$AnimationFrame$diffs(
						function (_p1) {
							return _ott8bre$elm_drones$Update$Tick(
								_elm_lang$core$Time$inSeconds(_p1));
						}),
					_1: {ctor: '[]'}
				}
			}
...
var _ott8bre$elm_drones$Main$main = _elm_lang$html$Html$program(
	{
		init: _ott8bre$elm_drones$Update$init,
		update: F2(
			function (msg, m) {
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					A2(_ott8bre$elm_drones$Update$update, msg, m),
					{ctor: '[]'});
			}),
		view: _ott8bre$elm_drones$View$view,
		subscriptions: _ott8bre$elm_drones$Main$subscriptions
	})();

var Elm = {};
Elm['Main'] = Elm['Main'] || {};
if (typeof _ott8bre$elm_drones$Main$main !== 'undefined') {
    _ott8bre$elm_drones$Main$main(Elm['Main'], 'Main', undefined);
}
