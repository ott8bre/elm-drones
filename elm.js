...
{
	if (region.ax.U === region.aL.U)
	{
		return 'on line ' + region.ax.U;
	}
	return 'on lines ' + region.ax.U + ' through ' + region.aL.U;
}
...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { bz: 'hidden', bo: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { bz: 'mozHidden', bo: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { bz: 'msHidden', bo: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { bz: 'webkitHidden', bo: 'webkitvisibilitychange' }
		: { bz: 'hidden', bo: 'visibilitychange' };
}
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {aN: fragment, aQ: host, aY: path, a_: port_, a1: protocol, a2: query};
	});
...
var $elm$browser$Browser$AnimationManager$State = F3(
	function (subs, request, oldTime) {
		return {as: oldTime, a5: request, be: subs};
	});
...
var $evancz$elm_playground$Playground$Mouse = F4(
	function (x, y, down, click) {
		return {ak: click, bs: down, aD: x, aE: y};
	});
var $evancz$elm_playground$Playground$Time = $elm$core$Basics$identity;
var $elm$core$Set$Set_elm_builtin = $elm$core$Basics$identity;
var $elm$core$Set$empty = $elm$core$Dict$empty;
var $evancz$elm_playground$Playground$emptyKeyboard = {ai: false, bs: false, am: false, j: $elm$core$Set$empty, A: false, O: false, aw: false, af: false, ah: false};
...
var $evancz$elm_playground$Playground$toScreen = F2(
	function (width, height) {
		return {aj: (-height) / 2, T: height, A: (-width) / 2, O: width / 2, aB: height / 2, aC: width};
	});
...
var $evancz$elm_playground$Playground$updateKeyboard = F3(
	function (isDown, key, keyboard) {
		var keys = isDown ? A2($elm$core$Set$insert, key, keyboard.j) : A2($elm$core$Set$remove, key, keyboard.j);
		switch (key) {
			case ' ':
				return _Utils_update(
					keyboard,
		...
		switch (msg.$) {
			case 1:
				...
				return A3(
					...
					computer.i.ak ? _Utils_update(
						computer,
						{
							i: A2($evancz$elm_playground$Playground$mouseClick, false, computer.i),
							ag: time
						}) : _Utils_update(
						computer,
						{ag: time}));
			case 2:
				var viewport = msg.a.bi;
				return A3(
					$evancz$elm_playground$Playground$Game,
					vis,
					memory,
					_Utils_update(
						computer,
						{
							F: A2($evancz$elm_playground$Playground$toScreen, viewport.aC, viewport.T)
						}));
			case 3:
				var w = msg.a;
				var h = msg.b;
			...
			case 0:
				...
				return A3(
					...
					_Utils_update(
						computer,
						{
							ab: A3($evancz$elm_playground$Playground$updateKeyboard, isDown, key, computer.ab)
						}));
			case 5:
				var pageX = msg.a;
				var pageY = msg.b;
				var y = computer.F.aB - pageY;
				var x = computer.F.A + pageX;
				return A3(
					$evancz$elm_playground$Playground$Game,
					vis,
					memory,
					_Utils_update(
						computer,
						{
							i: A3($evancz$elm_playground$Playground$mouseMove, x, y, computer.i)
						}));
			case 6:
				return A3(
					$evancz$elm_playground$Playground$Game,
					...
					_Utils_update(
						computer,
						{
							i: A2($evancz$elm_playground$Playground$mouseClick, true, computer.i)
						}));
			case 7:
				var isDown = msg.a;
				return A3(
					...
					_Utils_update(
						computer,
						{
							i: A2($evancz$elm_playground$Playground$mouseDown, isDown, computer.i)
						}));
			default:
				...
				return A3(
					...
					_Utils_update(
						computer,
						{
							ab: $evancz$elm_playground$Playground$emptyKeyboard,
							i: A4($evancz$elm_playground$Playground$Mouse, computer.i.aD, computer.i.aE, false, false)
						}));
		}
	});
...
var $evancz$elm_playground$Playground$initialComputer = {
	ab: $evancz$elm_playground$Playground$emptyKeyboard,
	i: A4($evancz$elm_playground$Playground$Mouse, 0, 0, false, false),
...
var $evancz$elm_playground$Playground$render = F2(
	function (screen, shapes) {
		var y = $elm$core$String$fromFloat(screen.aj);
		var x = $elm$core$String$fromFloat(screen.A);
		var w = $elm$core$String$fromFloat(screen.aC);
		var h = $elm$core$String$fromFloat(screen.T);
		return A2(
			$elm$svg$Svg$svg,
			_List_fromArray(
				[
...
var $evancz$elm_playground$Playground$game = F3(
	function (viewMemory, updateMemory, initialMemory) {
		...
		return $elm$browser$Browser$document(
			{aR: init, bR: subscriptions, bg: update, bh: view});
	});
...
var $author$project$Env$droneMaxLoad = 12;
var $author$project$Drone$init = F2(
	function (load, point) {
		return {ap: load, C: _List_Nil, E: point, l: _List_Nil};
	});
...
var $author$project$Point$origin = A2($author$project$Point$Point, 0, 0);
...
var $author$project$Env$warehouses = _List_fromArray(
	[
		{
		n: A2($author$project$Point$Point, -100, 0),
...
var $author$project$Main$startPoint = A2(
	$elm$core$Maybe$withDefault,
	$author$project$Point$origin,
	A2(
		$elm$core$Maybe$map,
		function ($) {
			return $.n;
		},
		$elm$core$List$head($author$project$Env$warehouses)));
var $author$project$Main$initDrone = A2($author$project$Drone$init, $author$project$Env$droneMaxLoad, $author$project$Main$startPoint);
var $author$project$Env$numberOfDrones = 5;
...
var $author$project$Packet$init = F4(
	function (item, copies, from, to) {
		return {bq: copies, ao: item, a3: to, a9: from};
	});
var $elm$core$Basics$neq = _Utils_notEqual;
var $author$project$Main$orderToPackets = function (order) {
	var f = F2(
		function (x, y) {
			return A4($author$project$Packet$init, x, y, $author$project$Main$startPoint, order.n);
		});
	var packs = A2($elm$core$Array$indexedMap, f, order.r);
	return A2(
		$elm$core$List$filter,
		function (p) {
			return !(!p.bq);
		},
		$elm$core$Array$toList(packs));
};
var $author$project$Env$orders = _List_fromArray(
	[
		{
		n: A2($author$project$Point$Point, 200, 100),
		r: $elm$core$Array$fromList(
			_List_fromArray(
				[0, 2, 0, 0, 1]))
	},
		{
		n: A2($author$project$Point$Point, -150, 100),
		r: $elm$core$Array$fromList(
			_List_fromArray(
				[0, 0, 0, 3, 0]))
	},
		{
		n: A2($author$project$Point$Point, 150, -150),
		r: $elm$core$Array$fromList(
			_List_fromArray(
				[0, 1, 1, 0, 1]))
	},
		{
		n: A2($author$project$Point$Point, 250, 50),
		r: $elm$core$Array$fromList(
			_List_fromArray(
				[2, 0, 0, 0, 1]))
	},
		...
		{
		n: A2($author$project$Point$Point, 50, 50),
		r: $elm$core$Array$fromList(
			_List_fromArray(
				[2, 0, 0, 0, 1]))
	},
		{
		n: A2($author$project$Point$Point, -250, 190),
		r: $elm$core$Array$fromList(
			_List_fromArray(
				[2, 0, 0, 0, 1]))
	},
...
var $author$project$Main$waresToProducts = function (ware) {
	return $elm$core$List$sum(
		$elm$core$Array$toList(ware.r));
};
var $author$project$Main$initialModel = {
	M: A2($elm$core$List$repeat, $author$project$Env$numberOfDrones, $author$project$Main$initDrone),
	C: $elm$core$List$concat(
		A2($elm$core$List$map, $author$project$Main$orderToPackets, $author$project$Env$orders)),
	au: A2($elm$core$List$map, $author$project$Main$waresToProducts, $author$project$Env$warehouses),
	ba: A2($author$project$Point$Point, 600, 400),
	Q: false,
	G: 1,
	Z: 0
};
...
var $author$project$Drone$isEmpty = function (model) {
	return $elm$core$List$isEmpty(model.C) && $elm$core$List$isEmpty(model.l);
};
var $author$project$Drone$Drop = function (a) {
	return {$: 1, a: a};
};
var $author$project$Drone$Take = function (a) {
	return {$: 0, a: a};
};
...
var $author$project$Env$weights = $elm$core$Array$fromList(
	_List_fromArray(
		[3, 1, 7, 2, 5]));
var $author$project$Env$weightOf = function (index) {
	return A2(
		$elm$core$Maybe$withDefault,
		0,
		A2($elm$core$Array$get, index, $author$project$Env$weights));
};
var $author$project$Packet$weight = function (_v0) {
	var item = _v0.ao;
	var copies = _v0.bq;
	return copies * $author$project$Env$weightOf(item);
};
var $author$project$Drone$weight = function (model) {
	return A3(
		$elm$core$List$foldr,
		$elm$core$Basics$add,
		0,
		A2($elm$core$List$map, $author$project$Packet$weight, model.C));
};
var $author$project$Drone$canLoad = F2(
	function (packet, drone) {
		var f = function (msg) {
			if (!msg.$) {
				var p = msg.a;
				return $author$project$Packet$weight(p);
			} else {
				return 0;
			}
		};
		var takingWeight = $elm$core$List$sum(
			A2($elm$core$List$map, f, drone.l));
		return _Utils_cmp(
			(takingWeight + $author$project$Drone$weight(drone)) + $author$project$Packet$weight(packet),
			drone.ap) < 1;
	});
var $author$project$Drone$enqueue = F2(
	function (msg, drone) {
		switch (msg.$) {
			case 0:
				var p = msg.a;
				return _Utils_update(
					drone,
					{
						l: A2($elm$core$List$cons, msg, drone.l)
					});
			case 1:
				var p = msg.a;
				return _Utils_update(
...
var $author$project$Main$takeDrop = F2(
	function (packet, _v0) {
		var drone = _v0.a;
		var rest = _v0.b;
		return A2($author$project$Drone$canLoad, packet, drone) ? _Utils_Tuple2(
			A2(
				$author$project$Drone$enqueue,
				$author$project$Drone$Drop(packet),
				A2(
					$author$project$Drone$enqueue,
					$author$project$Drone$Take(packet),
					drone)),
			rest) : _Utils_Tuple2(
			drone,
			A2($elm$core$List$cons, packet, rest));
	});
var $author$project$Drone$NoOp = {$: 2};
...
var $author$project$Point$distance = F2(
	function (p, q) {
		var square = function (a) {
			return a * a;
		};
		return $elm$core$Basics$sqrt(
			square(p.aD - q.aD) + square(p.aE - q.aE));
	});
var $author$project$Drone$distance = F2(
	function (p, q) {
		return $elm$core$Basics$floor(
			A2($author$project$Point$distance, p, q));
	});
var $author$project$Drone$stepTo = F2(
	function (src, dest) {
		var d = A2($author$project$Drone$distance, src, dest);
		var p = (!d) ? 1 : (1 / d);
		return _Utils_update(
			src,
			{aD: ((1 - p) * src.aD) + (p * dest.aD), aE: ((1 - p) * src.aE) + (p * dest.aE)});
	});
var $author$project$Drone$update = function (model) {
	var currentMsg = A2(
		$elm$core$Maybe$withDefault,
		$author$project$Drone$NoOp,
		$elm$core$List$head(model.l));
	switch (currentMsg.$) {
		case 0:
			var p = currentMsg.a;
			return _Utils_eq(p.a9, model.E) ? _Utils_update(
				model,
				{
					C: _Utils_ap(
						model.C,
						_List_fromArray(
							[p])),
					l: A2($elm$core$List$drop, 1, model.l)
				}) : _Utils_update(
				model,
				{
					E: A2($author$project$Drone$stepTo, model.E, p.a9)
				});
		case 1:
			var p = currentMsg.a;
			return _Utils_eq(p.a3, model.E) ? _Utils_update(
				model,
				{
					C: A2(
						$elm$core$List$filter,
						function (x) {
							return !_Utils_eq(x, p);
						},
						model.C),
					l: A2($elm$core$List$drop, 1, model.l)
				}) : _Utils_update(
				model,
				{
					E: A2($author$project$Drone$stepTo, model.E, p.a3)
				});
		default:
			return model;
	}
};
var $author$project$Main$updatePacketsDrones = F2(
	function (packets, drones) {
		var func = F2(
			function (drone, _v1) {
				...
				var _v0 = A3(
					$elm$core$List$foldr,
					$author$project$Main$takeDrop,
					_Utils_Tuple2(drone, _List_Nil),
					ps);
				var newDrone = _v0.a;
				var others = _v0.b;
				return _Utils_Tuple2(
					...
					A2(
						$elm$core$List$cons,
						$author$project$Drone$update(newDrone),
						ds));
			});
		return A3(
			$elm$core$List$foldr,
			func,
			_Utils_Tuple2(packets, _List_Nil),
			drones);
	});
var $author$project$Main$update = F2(
	function (env, model) {
		var toggle = (!model.Q) && env.ab.af;
		var terminated = $elm$core$List$isEmpty(model.C) && A2($elm$core$List$all, $author$project$Drone$isEmpty, model.M);
		var _v0 = model.G;
		if (!_v0) {
			var _v1 = A2($author$project$Main$updatePacketsDrones, model.C, model.M);
			var newPackets = _v1.a;
			var newDrones = _v1.b;
			return _Utils_update(
				model,
				{
					...
					C: newPackets,
					Q: env.ab.af,
					G: (toggle || terminated) ? 1 : model.G,
					Z: 1 + model.Z
				});
		} else {
			return toggle ? (terminated ? $author$project$Main$initialModel : _Utils_update(
				model,
				{Q: env.ab.af, G: 0})) : _Utils_update(
				model,
				{Q: env.ab.af});
		}
	});
...
var $evancz$elm_playground$Playground$brown = $evancz$elm_playground$Playground$Hex('#c17d11');
...
var $author$project$Main$drawPackets = F4(
	function (x, y, i, order) {
		...
		return A3(
			...
			x - (5 * k),
			y - 5,
			A3($evancz$elm_playground$Playground$rectangle, $evancz$elm_playground$Playground$brown, 4, 4));
	});
var $evancz$elm_playground$Playground$green = $evancz$elm_playground$Playground$Hex('#73d216');
var $author$project$Main$drawProducts = F4(
	function (x, y, i, size) {
		var range = A2($elm$core$List$range, 1, size);
		var k = 1 + i;
		var f = function (h) {
			return A3(
				$evancz$elm_playground$Playground$move,
				x + (5 * h),
				y + (5 * k),
				A3($evancz$elm_playground$Playground$rectangle, $evancz$elm_playground$Playground$green, 4, 4));
		};
		return A2(
			$elm$core$List$map,
			A2($elm$core$Basics$composeL, f, $elm$core$Basics$toFloat),
			range);
	});
var $evancz$elm_playground$Playground$Oval = F3(
	function (a, b, c) {
...
var $evancz$elm_playground$Playground$oval = F3(
	function (color, width, height) {
		return A6(
			...
			1,
			1,
			A3($evancz$elm_playground$Playground$Oval, color, width, height));
	});
var $author$project$Main$make = F3(
	function (radius, color, point) {
		return A3(
			$evancz$elm_playground$Playground$move,
			point.aD,
			point.aE,
			A3($evancz$elm_playground$Playground$oval, color, radius, radius));
	});
	...
	function (env, model) {
		var score = function () {
			...
			if (!_v1) {
				...
				return 'Turn ' + $elm$core$String$fromInt(model.Z);
			}
		}();
		var info = function () {
			var _v0 = model.G;
			if (!_v0) {
				...
				return 'press SPACE to start/pause';
			}
		}();
		return _Utils_ap(
			_List_fromArray(
				[
					A3($evancz$elm_playground$Playground$rectangle, $evancz$elm_playground$Playground$black, env.F.aC, env.F.T),
					A3(
					$evancz$elm_playground$Playground$move,
					0,
					40 - (env.F.T / 2),
					A2($evancz$elm_playground$Playground$words, $evancz$elm_playground$Playground$green, info)),
					A3(
					$evancz$elm_playground$Playground$move,
					0,
					(env.F.T / 2) - 40,
					A2($evancz$elm_playground$Playground$words, $evancz$elm_playground$Playground$green, score))
				]),
			_Utils_ap(
				A2(
					$elm$core$List$map,
					A2(
						...
						A2($author$project$Main$make, 5, $evancz$elm_playground$Playground$blue)),
					$author$project$Env$warehouses),
				_Utils_ap(
					A2(
						$elm$core$List$map,
						A2(
							...
							A2($author$project$Main$make, 5, $evancz$elm_playground$Playground$red)),
						$author$project$Env$orders),
					_Utils_ap(
						A2(
							$elm$core$List$map,
							A2(
								...
								A2($author$project$Main$make, 5, $evancz$elm_playground$Playground$white)),
							model.M),
						_Utils_ap(
							$elm$core$List$concat(
								A2(
									$elm$core$List$indexedMap,
									A2($author$project$Main$drawProducts, (-env.F.aC) / 2, (-env.F.T) / 2),
									model.au)),
							A2(
								$elm$core$List$indexedMap,
								A2($author$project$Main$drawPackets, env.F.aC / 2, env.F.T / 2),
								model.C))))));
	});
var $author$project$Main$main = A3($evancz$elm_playground$Playground$game, $author$project$Main$view, $author$project$Main$update, $author$project$Main$initialModel);
